...
uchar c,*p,*cp;
  ...
  for (i=4;i<y_size-4;i++){
    ...
    #pragma omp parallel for ordered(1) default(none) schedule(auto) firstprivate(mid,r,max_no,bp,x_size,in,i) private(w,y,x,b,a,m,do_symmetry,z,n,c,cp,p) num_threads(nthreads)  //spec(n)
