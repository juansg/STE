...
uchar c,*p,*cp;
  ...
  for (i=4;i<y_size-4;i++){
    ...
    #pragma omp taskloop grainsize(1)default(none) shared(next_iter_commit) firstprivate(mid,r,max_no,bp,x_size,in,i,STRIP_SIZE) private(cont,j,w,y,x,b,a,m,do_symmetry,z,n,c,cp,p) //spec(n)
