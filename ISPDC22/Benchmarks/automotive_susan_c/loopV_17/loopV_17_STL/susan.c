...
uchar c,*p,*cp;
  ...
  {
  */
  #pragma omp taskloop grainsize(1) default(none) shared(next_iter_commit,n) firstprivate(x_size,y_size,r,corner_list,cgx,cgy,in,STRIP_SIZE) private(j,x,i)   //spec(n)
