...
uchar c,*p,*cp;
  ...
  for (i=5;i<y_size-5;i++){
    ...
    #pragma omp taskloop grainsize(1) firstprivate(max_no,bp,in,cgx,cgy,r,x_size,i,STRIP_SIZE) private(n,j,x,c,p,cp,divide,y,xx,yy,sq) default(none) shared(next_iter_commit)   //spec(n)
